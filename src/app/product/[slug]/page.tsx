  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="w-full aspect-[3/4] bg-[var(--color-sable)] rounded-lg flex items-center justify-center">
          <span className="text-[var(--color-sable-dark)] font-serif text-2xl opacity-60">
            {product.name}
          </span>
        </div>
